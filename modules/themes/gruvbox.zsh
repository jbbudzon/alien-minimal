...
am_theme(){
  ...
  [[ -z ${AM_COMMIT_SINCE_COLOR} ]]     && AM_COMMIT_SINCE_COLOR=239
  [[ -z ${AM_FADE_COLOR} ]]             && AM_FADE_COLOR=241
  [[ -z ${AM_VENV_COLOR} ]]             && AM_VENV_COLOR=8
  [[ -z ${AM_PYTHON_COLOR} ]]           && AM_PYTHON_COLOR=11
  ...
  [[ -z ${AM_NODE_COLOR} ]]             && AM_NODE_COLOR=10
  [[ -z ${AM_PHP_COLOR} ]]              && AM_PHP_COLOR=5
  [[ -z ${AM_TIMER_COLOR} ]]            && AM_TIMER_COLOR=237
